...
public class AnswerDataTutorial : MonoBehaviour
{
    [Header("UI Elements")]
    ...
    public void OnClickAnswer()
    {
        ...
        {
            ManagerPiloto.Instance.TargetSelection(AnswerIndex, 1);
        }

        if (ManagerCopiloto.Instance)
        {
            ManagerCopiloto.Instance.TargetSelection(AnswerIndex, 1);
        }
